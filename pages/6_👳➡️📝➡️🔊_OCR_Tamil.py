...
#for audio(gTTS)
lang_dict = {'Tamil':'ta','English':'en'}
lang_key= list(lang_dict.keys())

acc_dict = {'Tamil':'co.in','English (Australia)':'com.au','English (United Kingdom)':'co.uk','English (United States)':'us',\
...
if uploaded_file is not None:
    ...
    result = st.session_state.reader6.readtext(uploaded_file.getvalue())
